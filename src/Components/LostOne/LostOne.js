...
const LostOne = () => {
  return (
    <div className="lost-home">
      <div className="lost-nav">
      ...
      <div className="lost-form">
        ...
        <form >
          ...
          <select id="citydropdown"
            required defaultValue={'city-not-given'}
          >
            {" "}
            <option value="city-not-given" selected disabled hidden>
              City*
            </option>
  ...
  function foo() {
    var city = document.getElementById('citydropdown').selectedOptions[0].value;
    var petname = document.getElementById('petname').value;
    var date = document.getElementById('lostdate').value;
    var desc = document.getElementById('desc').value;
    if (city == "city-not-given") {
      ...
      axios
        .post("http://localhost:3001/lost", { petname, date, desc, city })
        .then((result) => {
          console.log(result);
        })
